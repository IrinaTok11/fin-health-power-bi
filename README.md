...
fin-health-power-bi
├─ data/
│  ├─ integra_financial_analysis.xlsx   # sample / anonymised financials
│  ├─ sources.md                        # public-source references
│  └─ README.md
├─ dax/
│  ├─ measures.dax                      # all DAX measures, grouped
│  └─ README.md
├─ deneb/                               # Vega-Lite specs for Deneb visuals
...
├─ assets/                              # social / OG images
│  ├─ dashboard_cover.png
│  └─ dashboard_cover2.png
├─ fin-health.pbix                      # Power BI report
├─ LICENSE
└─ README.md
~~~
